...
const SUPPORTED: readonly SupportedLocale[] = ["ko", "en", "zh", "ja", "es", "fr"];
function safeLocale(loc: string): SupportedLocale {
  return SUPPORTED.includes(loc as SupportedLocale) ? (loc as SupportedLocale) : "en";
}
...
const PATENT_FAMILIES: PatentFamily[] = [
  {
    ...
    zh: { title: "含有8-oxo-2'-deoxyguanosine或其药学上可接受的盐作为有效成分的角膜损伤治疗用药学组合物" },
    ja: { title: "8-oxo-2'-deoxyguanosineまたはその薬学的に許容可能な塩を有効成分として含有する角膜損傷治療用薬学的組成物" },
    es: { title: "Composición farmacéutica que contiene 8-oxo-2'-deoxyguanosine para el tratamiento de enfermedades corneales" },
    fr: { title: "Composition pharmaceutique contenant de la 8-oxo-2'-deoxyguanosine pour le traitement des maladies cornéennes" },
    filings: [
  ...
  },
  {
    ...
    zh: { title: "含有8-oxo-2'-deoxyguanosine或其药学上可接受的盐的水溶液滴眼剂" },
    ja: { title: "8-oxo-2'-deoxyguanosineまたはその薬学的に許容可能な塩を含む水溶液形態の点眼剤" },
    es: { title: "Formulaciones de gotas oftálmicas en solución acuosa que comprenden 8-oxo-2'-deoxyguanosine" },
    fr: { title: "Formulations de collyre en solution aqueuse comprenant de la 8-oxo-2'-deoxyguanosine" },
    filings: [
  ...
  },
  {
    ...
    ja: { title: "2'-Deoxyguanosine誘導体またはその塩およびそれを含む薬学的組成物" },
    es: { title: "Derivados de 2'-deoxyguanosine o sus sales y composiciones farmacéuticas" },
    fr: { title: "Dérivés de 2'-deoxyguanosine ou leurs sels et compositions pharmaceutiques" },
    filings: [
  ...
  },
  {
    ...
    es: { title: "Composición farmacéutica para el tratamiento de enfermedades mediadas por TRPV1 (ingrediente activo GDF11)" },
    fr: { title: "Composition pharmaceutique pour le traitement des maladies médiées par TRPV1 (principe actif GDF11)" },
    filings: [
  ...
  },
  {
    ...
    es: { title: "Composición farmacéutica para la prevención o tratamiento del prurito que comprende un antagonista de TRPV1" },
    fr: { title: "Composition pharmaceutique pour la prévention ou le traitement du prurit comprenant un antagoniste de TRPV1" },
    filings: [
  ...
  },
  {
    ...
    ja: { title: "TRPV1拮抗剤を含む乾燥性眼疾患の予防または治療用薬学的組成物" },
    es: { title: "Composición farmacéutica para la prevención o tratamiento del ojo seco que comprende un antagonista de TRPV1" },
    fr: { title: "Composition pharmaceutique pour la prévention ou le traitement de la sécheresse oculaire comprenant un antagoniste de TRPV1" },
    filings: [
  ...
  },
  {
    ...
    fr: { title: "Biopuce hypothalamus-hypophyse et son procédé de fabrication" },
    filings: [
...
*/
type PaperLocale = { title: string; journal: string; authors: string; type: string };
const PAPERS: {
  year: number;
  ko: PaperLocale;
  en: PaperLocale;
...
}[] = [
  {
    ...
    es: {
      title: "Eficacia de RCI001 como candidato terapéutico en enfermedades de la superficie ocular",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "Artículo Original",
    },
    fr: {
      title: "Efficacité du RCI001 en tant que candidat thérapeutique dans les maladies de la surface oculaire",
      journal: "Cornea",
      authors: "Kim SH et al.",
  ...
  },
  {
    ...
    zh: {
      title: "小鼠眼碱烧伤模型中RCI001、Solcoseryl和Polydeoxyribonucleotide的角膜上皮创面愈合比较",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "原著论文",
    },
    ja: {
      title: "マウス眼アルカリ熱傷モデルにおけるRCI001、Solcoseryl、Polydeoxyribonucleotideの角膜上皮創傷治癒の比較",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "原著論文",
    },
    es: {
      title: "Comparación de la cicatrización epitelial corneal entre RCI001 tópico, Solcoseryl y Polydeoxyribonucleotide en el modelo murino de quemadura alcalina ocular",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "Artículo Original",
    },
    fr: {
      title: "Comparaison de la cicatrisation épithéliale cornéenne entre le RCI001 topique, le Solcoseryl et le Polydeoxyribonucleotide dans le modèle murin de brûlure alcaline oculaire",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "Article Original",
    },
  ...
  },
  {
    ...
    ja: {
      title: "眼表面疾患治療のためのRCI001の抗炎症効果の研究——作用機序に関する考察",
      journal: "Investigative Ophthalmology & Visual Science",
      authors: "Kim SH et al.",
      type: "原著論文",
    },
    es: {
      title: "Investigación de los efectos antiinflamatorios de RCI001 para el tratamiento de enfermedades de la superficie ocular: perspectiva del mecanismo de acción",
      journal: "Investigative Ophthalmology & Visual Science",
      authors: "Kim SH et al.",
      type: "Artículo Original",
    },
    fr: {
      title: "Étude des effets anti-inflammatoires du RCI001 pour le traitement des maladies de la surface oculaire : aperçu du mécanisme d'action",
      journal: "Investigative Ophthalmology & Visual Science",
      authors: "Kim SH et al.",
      type: "Article Original",
    },
  ...
  },
  {
    ...
    zh: {
      title: "眼碱烧伤模型中局部8-oxo-2'-deoxyguanosine与皮质类固醇的治疗效果比较",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "原著论文",
    },
    ja: {
      title: "眼アルカリ熱傷モデルにおける局所8-oxo-2'-deoxyguanosineとコルチコステロイドの治療効果の比較",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "原著論文",
    },
    es: {
      title: "Comparación de los efectos terapéuticos entre 8-oxo-2'-deoxyguanosine tópico y corticosteroides en el modelo de quemadura alcalina ocular",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "Artículo Original",
    },
    fr: {
      title: "Comparaison des effets thérapeutiques entre la 8-oxo-2'-deoxyguanosine topique et les corticostéroïdes dans le modèle de brûlure alcaline oculaire",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "Article Original",
    },
  ...
  },
  {
    ...
    zh: {
      title: "8-Oxo-2'-Deoxyguanosine的眼部分布及药代动力学——眼表疾病的新型治疗候选药物",
      journal: "Translational Vision Science & Technology",
      authors: "Kim SH et al.",
      type: "原著论文",
    },
    ja: {
      title: "8-Oxo-2'-Deoxyguanosineの眼内分布および薬物動態——眼表面疾患の新規治療候補物質",
      journal: "Translational Vision Science & Technology",
      authors: "Kim SH et al.",
      type: "原著論文",
    },
    es: {
      title: "Distribución ocular y farmacocinética de 8-Oxo-2'-Deoxyguanosine: un nuevo candidato terapéutico para enfermedades de la superficie ocular",
      journal: "Translational Vision Science & Technology",
      authors: "Kim SH et al.",
      type: "Artículo Original",
    },
    fr: {
      title: "Distribution oculaire et pharmacocinétique de la 8-Oxo-2'-Deoxyguanosine : un nouveau candidat thérapeutique pour les maladies de la surface oculaire",
      journal: "Translational Vision Science & Technology",
      authors: "Kim SH et al.",
      type: "Article Original",
    },
  ...
  },
  {
    ...
    zh: {
      title: "局部皮质类固醇对难治性干眼症的短期治疗效果——MMP-9检测作为反应预测标志物的临床实用性",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "原著论文",
    },
    ja: {
      title: "難治性ドライアイに対するコルチコステロイドの短期治療効果——MMP-9検査の反応予測マーカーとしての有用性",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "原著論文",
    },
    es: {
      title: "Efectos terapéuticos a corto plazo de los corticosteroides tópicos en la enfermedad del ojo seco refractario: utilidad clínica de la prueba de MMP-9 como marcador de predicción de respuesta",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "Artículo Original",
    },
    fr: {
      title: "Effets thérapeutiques à court terme des corticostéroïdes topiques sur la sécheresse oculaire réfractaire : utilité clinique du test MMP-9 comme marqueur de prédiction de la réponse",
      journal: "Cornea",
      authors: "Kim SH et al.",
      type: "Article Original",
    },
  ...
  },
  {
    ...
    es: {
      title: "Mejora de la precisión del cálculo de potencia de lentes intraoculares mediante el manejo preoperatorio de la enfermedad del ojo seco",
      journal: "Journal of Cataract & Refractive Surgery",
      authors: "Kim SH et al.",
      type: "Artículo Original",
    },
    fr: {
      title: "Amélioration de la précision du calcul de la puissance des lentilles intraoculaires par la gestion préopératoire de la sécheresse oculaire",
      journal: "Journal of Cataract & Refractive Surgery",
      authors: "Kim SH et al.",
      type: "Article Original",
    },
...
const CONTENT: Record<SupportedLocale, ContentBlock> = {
  ...
  zh: {
    ...
    title1: "专利 & ",
    title2: "论文",
    description: "保护和推进RudaCure核心技术与研究成果的专利组合及重要学术论文。",
    patentsTitle: "专利组合",
  ...
  ja: {
    ...
    title1: "特許 & ",
    title2: "論文",
    description: "RudaCureのコア技術と研究成果を保護する特許ポートフォリオおよび主要な学術論文です。",
    patentsTitle: "特許ポートフォリオ",
    patentsDescription: "イオンチャネル新薬開発のコア技術に関するグローバルな知的財産権を確保しています。",
    papersTitle: "主要研究論文",
    papersDescription: "国内外のSCI級ジャーナルに掲載されたRudaCureの主要な研究成果です。",
  ...
  es: {
    ...
    description: "Nuestro portafolio de patentes y publicaciones académicas clave que protegen y avanzan la tecnología central y los logros de investigación de RudaCure.",
    patentsTitle: "Portafolio de Patentes",
    patentsDescription: "Asegurando derechos de propiedad intelectual globales para las tecnologías centrales de descubrimiento de fármacos de canales iónicos.",
    papersTitle: "Publicaciones de Investigación Clave",
    papersDescription: "Logros de investigación clave de RudaCure publicados en revistas indexadas SCI nacionales e internacionales.",
  ...
  fr: {
    ...
    title1: "Brevets & ",
    title2: "Publications",
    description: "Notre portefeuille de brevets et nos publications académiques clés protégeant et faisant avancer la technologie centrale et les réalisations de recherche de RudaCure.",
    patentsTitle: "Portefeuille de Brevets",
    patentsDescription: "Sécurisation des droits de propriété intellectuelle mondiaux pour les technologies de découverte de médicaments ciblant les canaux ioniques.",
    papersTitle: "Publications de Recherche Clés",
    papersDescription: "Réalisations de recherche clés de RudaCure publiées dans des revues indexées SCI nationales et internationales.",
            ...
            return (
              <div key={pipeline} className="mb-10">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-xs text-gray-400">{familyCountLabel(families.length, locale)}</span>
                </div>
              ...
              <div key={year} className="mb-10">
                ...
                <div className="space-y-4">
                  {yearPapers.map((paper) => {
                    ...
                    return (
                      <div key={paper.pdf} className="liquid-glass p-6 hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4">
                          <div className="flex-shrink-0 mt-1">
                            <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${
                              pp.type === "원저" || pp.type === "Original Article" || pp.type === "原著论文" || pp.type === "原著論文" || pp.type === "Artículo Original" || pp.type === "Article Original"
                                ? "bg-blue-50 text-blue-700 border border-blue-200"
                                : pp.type === "리뷰" || pp.type === "Review" || pp.type === "综述" || pp.type === "総説" || pp.type === "Revisión" || pp.type === "Revue"
