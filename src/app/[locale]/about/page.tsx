  ...
  ko: [
    ...
    },
    {
      ...
      events: [
        ...
        { month: "7월", text: "7주년 창립기념식 및 5년 장기근속자 포상. 상반기 업무평가 워크샵" },
        { month: "8월", text: "RCI001 FDA Phase 2 IND 승인 획득. DT&CRO 연구협력 MOU. 일본 원천 특허 등록 완료" },
    ...
    },
    {
      ...
      events: [
        { month: "1월", text: "한림제약 각막손상 치료제 RCI001U 기술이전 계약. 한림제약 Rac1 저해제 70억 L/O" },
        { month: "2월", text: "통증 신규 펩타이드 특허 출원" },
        { month: "3월", text: "동물의약품 개발사 온힐·온힐펫과 협력. Bio-EU 파트너링" },
        { month: "4월", text: "고용노동부 강소기업 선정. 창업도약패키지 선정" },
        { month: "5월", text: "다래전략사업화센터 기술특례 컨설팅 계약" },
        { month: "6월", text: "ASCO 미국 임상종양학회 사절단 참석" },
        { month: "9월", text: "점안제 특허 출원 완료" },
    ...
    },
    {
      ...
      events: [
        { month: "2월", text: "JPM 미팅 성황. KIC 워싱턴 바이오 스타트업 챌린지" },
        { month: "4월", text: "신한 스퀘어브릿지 인천 선정. INNOBIZ 인증. KIC 워싱턴 협력 미팅" },
        { month: "5월", text: "시리즈A 60억원 투자유치. ARVO 학회 참석" },
        { month: "6월", text: "BIO-USA 한국관 참가. RCI001 안구건조증 혁신 신약 주목" },
        { month: "8월", text: "UKC 2022 IR Competition SBA상 수상. 서울 가산 사무소 이전. 가천대 공동연구 국가신약과제 선정" },
        { month: "9월", text: "RESI Innovator's Pitch Challenge 3위 입상" },
    ...
    },
    {
      ...
      events: [
        { month: "1월", text: "선바이오 비임상 CRO 연간계약. TRPV1 특허 미국 출원" },
        { month: "3월", text: "미국 임상 CRO(Ora) 업무계약. 인천스타트업파크 이주" },
        { month: "4월", text: "한림제약 150억원 규모 RCI001 기술이전 계약. 김동현 교수 Nature 자매지 논문 발표. 바이오의료기술개발사업 선정" },
        { month: "5월", text: "Big3 사업화 과제 선정. 의사창업 공동연구 기반구축" },
        { month: "6월", text: "김동현 전무 TOFS 위원회 멤버 선정. BioKorea 참석" },
        { month: "8월", text: "RudaCure U.S.A. Inc 설립. 과기부 감염병 대응 플랫폼 과제 선정. 바이오아이코어사업 선정" },
    ...
    },
    {
      ...
      events: [
        { month: "2월", text: "통증·안질환 신약연구 본격화" },
        { month: "6월", text: "R&D 재발견 프로젝트 선정. BIG3 혁신분야 창업패키지 선정" },
        { month: "7월", text: "RCI001 임상시험 기반 마련. 인천스타트업파크 입주 (Boost Startup Journey)" },
        { month: "8월", text: "글로벌 IP 지원 프로그램 선정" },
                      ...
                      <div className="mt-4 space-y-2">
                        {item.events.map((event, idx) => (
                          <div key={idx} className="flex gap-3 text-sm">
                            <span className="text-teal-600 font-mono font-medium w-10 shrink-0">{event.month}</span>
