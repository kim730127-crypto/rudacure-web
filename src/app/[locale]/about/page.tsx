...
const TIMELINE: Record<string, TimelineItem[]> = {
  ...
  ar: [
    {
      year: "2026",
      title: "التوسع السريري والعالمي في المرحلة 2",
      highlight: true,
      description:
        "نتائج مرحلية لمرحلة 2 من RCI001 لدى FDA. توسيع منصة RuCIA لأمراض الحس النادرة. صفقات ترخيص في اليابان/أوروبا.",
      events: [
        { month: "Q1", text: "شراكة عالمية مع BioChina" },
        {
          month: "Q2",
          text: "التحول إلى معايير IFRS والبنية التحتية للرقابة الداخلية",
        },
      ],
    },
    {
      year: "2025",
      title: "المعالم السريرية والخاصة بالعرض العام الأولي",
      description:
        "موافقة FDA على طلب بدء التجارب السريرية (IND) لمرحلة 2 من RCI001. اختيار وسيط العرض العام الأولي. جائزة الشركة المتميزة في إنشون وشهادة Hi-Seoul.",
      events: [
        {
          month: "يناير",
          text: "حفل رأس السنة 2025 وجوائز الموظف المتميز/المثالي",
        },
        {
          month: "فبراير",
          text: "محاضرة البروفيسور كwon من POSTECH حول التحليل البنيوي لـ TRPV1",
        },
        {
          month: "مارس",
          text: "اجتماع استشاري لمرحلة 2 من RCI001 (13 طبيب عيون). اجتماع Bio-Europe الربيع والدواء البيطري متعدد الجنسيات",
        },
        {
          month: "أبريل",
          text: "أنشطة ESG — تنظيف مجرى أنيانغ وحملة التبرع بالدم",
        },
        {
          month: "مايو",
          text: "اختيار برنامج ريادة الأعمال في مجال الأغذية الزراعية (العلاج الجيني البيطري). جناح بايو-كوريا. تعاون البحث والتطوير مع سينتيكابيوا",
        },
        {
          month: "يونيو",
          text: "الشراكة العالمية في BIO-USA (سانتن، ثيا). عرض RCI001 في الجمعية الأوروبية لجفاف العين",
        },
        {
          month: "يوليو",
          text: "احتفال بالذكرى السنوية السابعة وتكريم الموظفين ذوي الخدمة لخمس سنوات. ورشة عمل لمراجعة أداء النصف الأول",
        },
        {
          month: "أغسطس",
          text: "موافقة FDA على طلب بدء التجربة السريرية من المرحلة 2 لـ RCI001. توقيع مذكرة تفاهم بحثية مع DT&CRO. تسجيل براءة الاختراع في اليابان",
        },
        {
          month: "أكتوبر",
          text: "شهادة Hi-Seoul Enterprise. حضور قمة علاجات الألم",
        },
        {
          month: "نوفمبر",
          text: "جائزة شركة مرموقة في إنشيون. عرض علاجات الألم من الجيل القادم في SfN",
        },
        {
          month: "ديسمبر",
          text: "اختيار ممول الطرح العام الأولي. التبرع بطن من طعام القطط لمأوى القطط الضالة (المسؤولية الاجتماعية للشركات)",
        },
      ],
    },
    {
      year: "2024",
      title: "التحقق السريري واختيار الأحادية",
      description:
        "التجربة السريرية المحلية من المرحلة 1 لـ RCI001. تصنيف Baby Unicorn. زيادة رأس المال TIPS بمبلغ 1.2 مليار وون كوري.",
      events: [
        { month: "يناير", text: "حفل رأس السنة 2024" },
        {
          month: "مارس",
          text: "موافقة على تجربة سريرية محلية من المرحلة 1 لـ RCI001. زيارة إلى شركة الأدوية البيطرية متعددة الجنسيات (تطوير مشترك لـ RCI001AH)",
        },
        { month: "أبريل", text: "برنامج تسريع IBK Innovation Hub Europe" },
        {
          month: "مايو",
          text: "إطلاق مبادرات إدارة ESG. جناح Bio-Korea BioHealth",
        },
        {
          month: "يونيو",
          text: "اختيار كـ 'وحيد القرن الصغير' من قبل وزارة الشركات الصغيرة والمتوسطة. حضور BIO-USA 2024",
        },
        {
          month: "أكتوبر",
          text: "اختيار ضمن برنامج Scale-up TIPS (1.2 مليار وون كوري على مدى 3 سنوات). فعالية RCI001 في نموذج متلازمة شوغرن",
        },
        {
          month: "ديسمبر",
          text: "الجائزة الكبرى في Core Innovation Korea 2024. عقد اكتشاف أدوية مضادة للسرطان مع Syntekabio",
        },
      ],
    },
    {
      year: "2023",
      title: "الشراكات الاستراتيجية والوصول العالمي",
      description:
        "نقلان تقنيان من Hanlim Pharma. مبادرة الأدوية البيطرية. عرض في مؤتمر ACR.",
      events: [
        {
          month: "يناير",
          text: "نقل تقنية Hanlim Pharma لعلاج القرنية RCI001U. صفقة ترخيص بقيمة 7 مليارات وون كوري لمثبط Rac1",
        },
        { month: "فبراير", text: "تقديم براءة اختراع جديدة لببتيد الألم" },
        {
          month: "مارس",
          text: "شراكة في الأدوية البيطرية مع Onheal/OnhealPet. شراكات Bio-EU",
        },
        {
          month: "أبريل",
          text: "تصنيف كـ 'شركة صغيرة قوية' من وزارة التوظيف. الاختيار ضمن حزمة Startup Leap",
        },
        {
          month: "مايو",
          text: "اتفاقية استشارات تقنية مع Darae Strategic Center",
        },
        { month: "يونيو", text: "وفد الأورام السريرية ASCO" },
        { month: "سبتمبر", text: "تقديم براءة اختراع لصيغة قطرة عين" },
        {
          month: "أكتوبر",
          text: "برنامج تجاري لتقنية سيول. دراسة أمان طويلة الأمد لبروفيسور كيم RCI001. جولة الابتكار العالمية في سنغافورة",
        },
        {
          month: "نوفمبر",
          text: "عرض علاجي لـ TRPV1 لالتهاب المفاصل التنكسي في ACR. جائزة KICDC/Defy Pitch. Bio-Europe 2023",
        },
        {
          month: "ديسمبر",
          text: "اتفاقية بحث مشترك بين مستشفى هاليوم وIonCell لـ CAR-T/ADC",
        },
      ],
    },
    {
      year: "2022",
      title: "الاستثمار والاعتراف العالمي",
      description:
        "جمع 6 مليار وون كوري في الجولة A. المركز الثالث في RESI. استعدادات سريرية في الولايات المتحدة.",
      events: [
        {
          month: "فبراير",
          text: "اجتماعات مؤتمر JPM. تحدي الشركات الناشئة الحيوية في KIC واشنطن",
        },
        {
          month: "أبريل",
          text: "جسر شينهان في إنشيون. شهادة INNOBIZ. شراكة KIC واشنطن",
        },
        {
          month: "مايو",
          text: "جمع استثمار 6 مليار وون كوري في الجولة A. مؤتمر ARVO",
        },
        {
          month: "يونيو",
          text: "الجناح الكوري في BIO-USA. الضوء على دواء RCI001 المبتكر لجفاف العين",
        },
        {
          month: "أغسطس",
          text: "جائزة SBA في مسابقة UKC 2022 IR. نقل مكتب سيول إلى غاسان. مشروع دوائي وطني لجامعة غاتشون",
        },
        { month: "سبتمبر", text: "تحدي RESI للمبتكرين — المركز الثالث" },
        { month: "أكتوبر", text: "تقديم براءة اختراع TRPV1 في اليابان/الصين" },
        { month: "نوفمبر", text: "تصنيف كمتوسط صغير لتنمية المواهب" },
        {
          month: "ديسمبر",
          text: "شهادة صديقة للعائلة وشركة ناشئة قوية صديقة للشباب",
        },
      ],
    },
    {
      year: "2021",
      title: "نقل التقنية والفرع الأمريكي",
      description:
        "نقل تقنية بقيمة 15 مليار وون كوري من Hanlim Pharma. تأسيس RudaCure U.S.A. منح حكومية متعددة.",
      events: [
        {
          month: "يناير",
          text: "عقد سنوي مع SunBio كجهة خدمات بحثية قبل سريرية. تقديم براءة اختراع أمريكية لـ TRPV1",
        },
        {
          month: "مارس",
          text: "عقد مع CRO سريري أمريكي (Ora). الانتقال إلى حديقة إنشيون للمبتكرين",
        },
        {
          month: "أبريل",
          text: "نقل تقنية RCI001 بقيمة 15 مليار وون كوري من Hanlim Pharma. ورقة بحثية في مجلة أخت Nature للبروفيسور Kim. مشروع تطوير التكنولوجيا الطبية الحيوية",
        },
        {
          month: "مايو",
          text: "مشروع تجاري BIG3. برنامج بحث مشترك مع الشركات الناشئة الطبية",
        },
        {
          month: "يونيو",
          text: "اختيار EVP Kim كعضو في لجنة TOFS. BioKorea 2021",
        },
        {
          month: "أغسطس",
          text: "تأسيس RudaCure U.S.A. Inc. مشروع منصة الأمراض المعدية من MSIT. برنامج Bio-iCore",
        },
        {
          month: "ديسمبر",
          text: "الحصول على براءة اختراع محلية لـ TRPV1. البروفيسور Kim — جائزة KOES الأكاديمية وجائزة Taejun لأفضل ورقة بحثية",
        },
      ],
    },
    {
      year: "2020",
      title: "أساس خط الأنابيب",
      description:
        "تأسيس أساسيات التجربة السريرية لـ RCI001. اختيار في BIG3 للابتكار والنمو. حديقة إنشيون للمبتكرين.",
      events: [
        {
          month: "فبراير",
          text: "إطلاق كامل أبحاث أدوية الألم والعين",
        },
        {
          month: "يونيو",
          text: "اختيار في مشروع إعادة اكتشاف R&D. حزمة BIG3 للشركات الناشئة المبتكرة",
        },
        {
          month: "يوليو",
          text: "تأسيس أساس التجربة السريرية لـ RCI001. الانضمام إلى حديقة إنشيون للمبتكرين (رحلة تعزيز الشركات الناشئة)",
        },
        { month: "أغسطس", text: "تم اختيار برنامج دعم الملكية الفكرية العالمية" },
        {
          month: "ديسمبر",
          text: "عقد سريري أمريكي لـ SunBio MucoPEG. برنامج استشارات البحث والتطوير في إنشون",
        },
      ],
    },
    {
      year: "2019",
      title: "البحث المبكر ونقل التكنولوجيا",
      description:
        "نقل براءات اختراع أمراض العيون من مستشفى جيل. استضافة ندوة آلام آسيا.",
      events: [
        {
          month: "ديسمبر",
          text: "نقل براءات اختراع أمراض العيون المسنّة من مستشفى جيل. ندوة آلام آسيا في سونغدو. تطوير مشترك لتجديد العمود الفقري مع مستشفى تشا بوندانغ",
        },
      ],
    },
    {
      ...
      title: "الأساس",
      description:
        "تأسست على يد الدكتور يونغ-هو كيم (جامعة غاتشون). علاجات تستهدف قنوات الأيونات لأمراض الألم والحس.",
    },
  ],
};
  ...
  ar: [
    {
      ...
      description:
        "أستاذ في جامعة غاتشون متخصص في علم الأدوية لقنوات الأيونات وأبحاث الألم.",
    },
    {
      name: "Seung-hoon Kim",
      role: "نائب الرئيس",
      description:
        "عمليات CMC، تطوير منصة الذكاء الاصطناعي، والاستراتيجية المؤسسية.",
    },
  ],
};
...
const CONTENT = {
  ...
  ar: {
    ...
    title2: "رحلتنا",
    description:
      "من مختبر متخصص في قنوات الأيونات في 2018 إلى شركة حيوية عالمية في 2026 — قصة RudaCure.",
    leaderTag: "القيادة",
    leaderTitle: "الفريق",
  },
};
