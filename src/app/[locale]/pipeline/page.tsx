...
const PIPELINE: Record<string, PipelineItem[]> = {
  ko: [
    {
      ...
      mechanism:
        "TRPV1 하부 시그널 조절을 통한 Rac1/NLRP3 염증 억제 — 눈물 분비 촉진 및 각막 치유",
    ...
    },
    {
      ...
      mechanism:
        "TRPV1과 MOR을 동시 조절하는 MOR biased 듀얼 타깃 비마약성 진통제 — CRPS 희귀질환 ODD 준비 중",
  ...
  en: [
    {
      ...
      target: "TRPV1-Rac1 Target",
      mechanism:
        "TRPV1 downstream signal modulation inhibiting Rac1/NLRP3 inflammation — promotes tear secretion and corneal healing",
  ...
  zh: [
    ...
    },
    {
      ...
      target: "TRPV1-MOR Biased Dual Target",
      mechanism:
        "同时调节TRPV1和MOR的MOR biased双靶点非阿片类镇痛药 — 准备CRPS孤儿药认定",
  ...
  fr: [
    {
      ...
      milestones: [
        ...
        "Licence Hanlim Pharma (RCI001/RCI001U)",
        "Co-développement Pharma Vétérinaire Français (RCI001AH)",
    ...
    },
    {
      ...
      target: "TRPV1-MOR Biased Dual Target",
      mechanism:
        "Analgésique non opioïde à double cible MOR biased modulant simultanément TRPV1 et MOR — préparation de la Désignation de Médicament Orphelin pour le CRPS",
      ...
      milestones: [
        ...
        "Désignation de Médicament Orphelin (ODD) pour CRPS en Préparation",
      ...
      details: [
        ...
        "Désignation FDA ODD pour CRPS en préparation",
      ],
      detailsLabel: "Caractéristiques Clés",
      milestonesLabel: "Jalons",
    },
