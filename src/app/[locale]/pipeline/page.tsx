...
> = {
  ...
  ar: {
    ...
    title2: "خط الإنتاج",
    description:
      "خط إنتاج علاجي يستهدف البروتينات الغشائية. المرشحون المكتشفون عبر منصتنا RuCIA يتقدمون نحو التجارب السريرية العالمية.",
  },
};
  ...
  ar: [
    {
      ...
      details: [
        ...
        "تجاوز آثار الستيرويدات الجانبية: لا ارتفاع في ضغط العين، لا احمرار، لا حرقان",
        "تجنب حجب الإحساس الحراري الشائع لدى مضادات TRPV1 من الجيل الأول",
        "تم منح براءات اختراع لعلاج أمراض TRPV1 النشطة في كوريا واليابان والولايات المتحدة",
      ],
      detailsLabel: "تفاصيل رئيسية",
      milestonesLabel: "المعالم الرئيسية",
    },
    {
      name: "RCI001AH",
      indication: "جفاف العين البيطري (التهاب الملتحمة والجفاف)",
      target: "معدِّل مسارات TRPV1-Rac1",
      mechanism:
        "نفس آلية العمل لـ RCI001 — ينظم سلسلة التفاعل الالتهابي الهابطة TRPV1/Rac1/NLRP3. صيغة بيطرية تستهدف جفاف العين في الحيوانات الأليفة (الكلاب/القطط).",
      status: "PoC Complete / Preparing Veterinary Trials",
      progress: 45,
      color: "emerald",
      milestones: [
        "اكتمال دراسة إثبات المفهوم",
        "إجراء دراسة مقارنة مع السيكلوسبورين البيطري",
        "التحضير للتجارب السريرية البيطرية",
        "تطوير مشترك مع شركة أدوية بيطرية متعددة الجنسيات (استهداف سوق 2030)",
      ],
      details: [
        "نفس آلية العمل لـ RCI001 (تعديل TRPV1-Rac1/NLRP3 downstream)",
        "استهداف جفاف العين (KCS) في الحيوانات الأليفة (الكلاب/القطط)",
        "اكتمال دراسة إثبات المفهوم",
        "إجراء دراسة مقارنة مع السيكلوسبورين البيطري",
        "تطوير مشترك مع شركة أدوية بيطرية متعددة الجنسيات، استهداف دخول السوق في 2030",
      ],
      detailsLabel: "تفاصيل رئيسية",
      milestonesLabel: "المعالم الرئيسية",
    },
    {
      name: "RCI002",
      indication: "الألم المزمن (داخل المفصل)",
      target: "منشط MOR · توصيل داخل المفصل",
      mechanism:
        "منشط MOR عالي الفعالية للتوصيل داخل المفصل — تسكين موضعي مع تقليل التعرض الجهازي. تم تقديم طلب تصنيف دواء نادر لـ CRPS",
      status: "Pre-clinical / IND Prep (CRPS ODD Submitted)",
      progress: 40,
      color: "blue",
      milestones: [
        "اكتمال دراسات الفعالية ما قبل السريرية",
        "أبحاث الصياغة (د. دونغجين جانغ، جامعة غانغون)",
        "تم تقديم طلب تصنيف دواء نادر (ODD) لـ CRPS",
        "عرض في مؤتمر SfN (2025.11)",
        "تمويل توسيع TIPS بمبلغ KRW 1.2B (2024)",
        "تقديم IND عالميًا في الربع الثاني من 2026",
        "بدء المرحلة 1 في النصف الثاني من 2026",
      ],
      details: [
        "المؤشرات: CRPS، OA، اعتلال الأعصاب السكري، CIPN، الألم العضلي الليفي",
        "التوصيف داخل المفصل يقلل التعرض الجهازي",
        "جرعة واحدة: تخفيف الألم لمدة 2+ أسابيع في نموذج OA",
        "لم يُرصد ارتفاع في درجة حرارة الجسم في دراسات القوارض والقردة",
        "تقديم طلب للحصول على تصنيف FDA كدواء نادر (ODD) لـ CRPS",
      ],
      detailsLabel: "تفاصيل رئيسية",
      milestonesLabel: "المعالم الرئيسية",
    },
    {
      name: "RCI003",
      indication: "الصدفية",
      target: "منظم انتقائي لبروتينات أهداف الصدفية",
      mechanism:
        "تنظيم انتقائي مبني على منصة الأدوية بالذكاء الاصطناعي لبروتينات أهداف الصدفية — بالاستفادة من خبرة قناة الأيون TRPV1",
      status: "Discovery",
      progress: 15,
      color: "violet",
      milestones: [
        "اختيار Syntekabio Collabo R&D للمرحلة 2 (2026)",
        "اختيار Syntekabio Collabo R&D (2024)",
        "إجماع جامعة سونغان وجامعة إنجي",
        "تحليل الأهداف لمنصة الذكاء الاصطناعي (STB)",
        "تخليق المركب المرشح قيد التنفيذ",
        "تقييم الفعالية المخطط لها خارج الجسم/داخل الجسم",
      ],
      details: [
        "منصة Syntekabio AI (STB) لتحليل البروتين المستهدف",
        "خبرة RudaCure في TRPV1 مطبقة على قنوات الأيونات في أمراض الجلد",
        "جامعة سوغان: تخليق وتحسين المركبات",
        "جامعة إنجي: تقييم فعالية المركبات المرشحة",
        "فترة البحث: أبريل 2026 – مارس 2028",
      ],
      detailsLabel: "تفاصيل رئيسية",
      milestonesLabel: "المعالم الرئيسية",
    },
    {
      name: "RC0125 AAV",
      indication:
        "CMT2C (داء شاركو-ماري-توث 2C)، خلل تنسج هيكلي، انحراف العمود الفقري، تشوهات هيكلية",
      target: "الهدف داخل الخلية لـ TRPV4 (نوع AAV)",
      mechanism:
        "علاج جيني قائم على ناقل AAV يستهدف TRPV4 داخل الخلية — تم تطويره كدواء نادر مع خطط للتوسع إلى أمراض ذات صلة",
      status: "Drug Optimization",
      progress: 25,
      color: "teal",
      milestones: [
        "تأكيد الفعالية المسكنة في نماذج OA (التهاب المفاصل التنكسي)",
        "التحقق من آلية استهداف TRPV4 داخل الخلية",
        "تحسين مستمر لدواء العلاج الجيني AAV",
        "تطوير مرض نادر (CMT2C) مع خطط للتوسع إلى مؤشرات ذات صلة",
      ],
      details: [
        "علاج جيني قائم على ناقل AAV يستهدف قناة TRPV4 داخل الخلية",
        "فعالية مسكنة مثبتة في نماذج حيوانية لالتهاب المفاصل التنكسي (OA)",
        "يخضع حاليًا لتحسين المرشح الدوائي",
        "الهدف الأولي هو علاج مرض CMT2C النادر، مع خطط للتوسع إلى اضطرابات ذات صلة",
      ],
      detailsLabel: "تفاصيل رئيسية",
      milestonesLabel: "المعالم الرئيسية",
    },
...
export default async function PipelinePage({
  ...
  const locale = (
    ["ko", "en", "zh", "ja", "es", "fr", "ar"].includes(loc) ? loc : "en"
  ) as string;
