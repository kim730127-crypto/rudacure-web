...
> = {
  ...
  en: [
    {
      value: "$94B",
      label: "Global Chronic Pain Market",
      sub: "Projected by 2030",
    },
    {
      value: "Phase 2",
      label: "RCI001 FDA Clinical Trial",
      sub: "Dry Eye Disease (Ongoing)",
    },
    {
      value: "70%",
  ...
  es: [
    {
      value: "$94B",
      label: "Mercado Global de Dolor Cronico",
      sub: "Proyectado para 2030",
    },
    {
      value: "Phase 2",
      label: "Ensayo Clinico FDA RCI001",
      sub: "Ojo Seco (En curso)",
    },
    {
      value: "70%",
      label: "Reduccion del Tiempo de Desarrollo",
  ...
  fr: [
    {
      value: "$94B",
      label: "Marche Mondial de la Douleur Chronique",
      sub: "Projection 2030",
    },
    {
      value: "Phase 2",
      label: "Essai Clinique FDA RCI001",
      sub: "Secheresse Oculaire (En cours)",
    },
    {
      value: "70%",
...
const ROADMAP: Record<
  IRLocale,
  { quarter: string; title: string; status: string }[]
> = {
  ko: [
    {
      quarter: "Q1 2026",
      title: "IPO 주관사 선정 및 본격 IPO 돌입",
      status: "active",
    },
    {
      quarter: "Q2 2026",
      title: "RCI001 국내 임상 2상 진입",
      status: "upcoming",
    },
  ...
  en: [
    {
      quarter: "Q1 2026",
      title: "IPO Underwriter Selection & Full-Scale IPO Launch",
      status: "active",
    },
    {
      quarter: "Q2 2026",
      title: "RCI001 Korea Phase 2 Clinical Trial Entry",
      status: "upcoming",
    },
    { quarter: "Q3 2026", title: "RCI002 ODD Designation", status: "upcoming" },
    {
      quarter: "Q4 2026",
      title: "RCI002 Global Licensing",
      status: "upcoming",
    },
  ],
  zh: [
    {
      quarter: "Q1 2026",
      title: "IPO承销商选定及全面启动IPO",
      status: "active",
    },
    {
      quarter: "Q2 2026",
      title: "RCI001韩国二期临床试验启动",
      status: "upcoming",
    },
  ...
  ja: [
    {
      quarter: "Q1 2026",
      title: "IPO主幹事選定及び本格IPO開始",
      status: "active",
    },
    {
      quarter: "Q2 2026",
      title: "RCI001韓国第2相臨床試験開始",
      status: "upcoming",
    },
    { quarter: "Q3 2026", title: "RCI002 ODD指定", status: "upcoming" },
    {
      quarter: "Q4 2026",
      title: "RCI002グローバルライセンシング",
      status: "upcoming",
    },
  ],
  es: [
    {
      quarter: "Q1 2026",
      title: "Seleccion de Suscriptor de IPO y Lanzamiento Completo",
      status: "active",
    },
    {
      quarter: "Q2 2026",
      title: "RCI001 Entrada a Fase 2 en Corea",
      status: "upcoming",
    },
    { quarter: "Q3 2026", title: "RCI002 Designacion ODD", status: "upcoming" },
    {
      quarter: "Q4 2026",
      title: "RCI002 Licenciamiento Global",
      status: "upcoming",
    },
  ],
  fr: [
    {
      quarter: "Q1 2026",
      title: "Selection du Souscripteur IPO et Lancement Complet",
      status: "active",
    },
    {
      quarter: "Q2 2026",
...
const INVESTMENT_CASE: Record<
  IRLocale,
  {
    title: string;
    description: string;
    icon: "handshake" | "chart" | "ai" | "target";
  }[]
> = {
  ko: [
    {
    ...
    },
    {
      title: "다각화된 수익원",
      description:
        "인체 의약품, 동물의약품, 의약품 원료 공급, CRO 서비스로 수익 다변화 및 지속가능기업 구현.",
      icon: "chart",
    },
    {
      title: "확장 가능한 AI 플랫폼",
      description:
        "RuCIA로 후보물질 발굴 시간/비용 대폭 절감. 감각 질환 전반으로 적용 확대.",
      icon: "ai",
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      description:
        "Human pharmaceuticals, veterinary medicines, API supply, and CRO services for revenue diversification and sustainable growth.",
      icon: "chart",
    },
    {
      title: "Scalable AI Platform",
      description:
        "RuCIA enables rapid candidate identification with significantly reduced cost and development time.",
      icon: "ai",
    },
    {
  ...
  zh: [
    ...
    },
    {
      title: "多元化收入来源",
      description:
        "人用药品、动物药品、原料药供应及CRO服务，实现收入多元化与可持续发展。",
      icon: "chart",
    },
    {
      title: "可扩展的AI平台",
      description:
        "RuCIA大幅缩短候选药物发现时间与成本，向感觉疾病全领域扩展应用。",
      icon: "ai",
    },
    {
      title: "非阿片类市场先发优势",
  ...
  ja: [
    ...
    },
    {
      title: "多角化された収益源",
      description:
        "人体医薬品、動物用医薬品、原薬供給、CROサービスによる収益多角化と持続可能な成長の実現。",
      icon: "chart",
    },
    {
      title: "スケーラブルなAIプラットフォーム",
      description:
        "RuCIAにより候補物質の発掘時間とコストを大幅に削減。感覚疾患全般への適用拡大。",
      icon: "ai",
    },
    {
  ...
  es: [
    ...
    {
      title: "Fuentes de Ingresos Diversificadas",
      description:
        "Farmaceuticos humanos, medicamentos veterinarios, suministro de API y servicios CRO para diversificacion de ingresos y crecimiento sostenible.",
      icon: "chart",
    },
    {
      title: "Plataforma de IA Escalable",
      description:
        "RuCIA permite la identificacion rapida de candidatos con reduccion significativa de costo y tiempo de desarrollo.",
      icon: "ai",
    },
    {
  ...
  fr: [
    ...
    {
      title: "Sources de Revenus Diversifiees",
      description:
        "Produits pharmaceutiques humains, medicaments veterinaires, fourniture d'API et services CRO pour la diversification des revenus et la croissance durable.",
      icon: "chart",
    },
    {
      title: "Plateforme IA Evolutive",
      description:
        "RuCIA permet l'identification rapide de candidats avec une reduction significative des couts et du temps de developpement.",
      icon: "ai",
    },
    {
...
export async function generateMetadata({
  ...
  const description =
    "RudaCure investment overview, pipeline milestones, market opportunity, and 2026 strategic roadmap.";
  return {
